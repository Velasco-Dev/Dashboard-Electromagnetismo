...
class Measurement {
  static async create(data) {
    ...
    const document = {
      ...
      voltaje_carga: data.voltaje_carga || 0,
      corriente_carga: data.corriente_carga || 0,
      potencia_panel: data.potencia_panel || 0,
      potencia_bateria: data.potencia_bateria || 0,
      potencia_carga: data.potencia_carga || 0,
    ...
    return await collection.aggregate([
      {
        $group: {
          ...
          voltaje_carga_promedio: { $avg: '$voltaje_carga' },
          potencia_panel_promedio: { $avg: '$potencia_panel' },
          potencia_bateria_promedio: { $avg: '$potencia_bateria' },
          potencia_carga_promedio: { $avg: '$potencia_carga' },
